...
public class DisplayGame extends javax.swing.JPanel
{
  ...
  {
    addComponentListener(new java.awt.event.ComponentListener() { public void componentHidden(ComponentEvent e) {}
      
      public void componentMoved(ComponentEvent e) {}
      
      public void componentShown(ComponentEvent e) {}
      public void componentResized(ComponentEvent e) { resetSize(getWidth(), getHeight());
      }
  ...
  protected void bind(SimulatorEngine engine)
  {
    ...
    lines.add(new Line(new Point(engine.getWorldWidth() + 1, engine.getWorldHeight() + 1), new Point(engine.getWorldWidth() + 1, -1)));
    lines.add(new Line(new Point(engine.getWorldWidth() + 1, engine.getWorldHeight() + 1), new Point(-1, engine.getWorldHeight() + 1)));
  }
  
  protected void start(int width, int height) { FileLoader loader = new FileLoader();
    try {
  ...
  protected void resetSize(int width, int height) { setPreferredSize(new java.awt.Dimension(width, height));
  ...
  private void resetImageSize() { if (teamAMainBotRaw.getWidth() < teamAMainBotRaw.getHeight()) {
    ...
    teamAMainBot = config.createCompatibleImage((int)(2.0D * zoomFactor * 50.0D), (int)(2.0D * zoomFactor * 50.0D), 3);
    teamBMainBot = config.createCompatibleImage((int)(2.0D * zoomFactor * 50.0D), (int)(2.0D * zoomFactor * 50.0D), 3);
    teamASecondaryBot = config.createCompatibleImage((int)(2.0D * zoomFactor * 50.0D), (int)(2.0D * zoomFactor * 50.0D), 3);
    teamBSecondaryBot = config.createCompatibleImage((int)(2.0D * zoomFactor * 50.0D), (int)(2.0D * zoomFactor * 50.0D), 3);
    ...
    teamASecondaryBotAffineTransform.translate(-teamASecondaryBotRaw.getWidth() / 2, -teamASecondaryBotRaw.getHeight() / 2);
    ...
    teamBSecondaryBotAffineTransform.translate(-teamBSecondaryBotRaw.getWidth() / 2, -teamBSecondaryBotRaw.getHeight() / 2);
  ...
  public void paintComponent(Graphics g) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      af.translate((int)((((Bot)engine.getBots().get(i)).getX() - 50.0D) * zoomFactor + xModifier), (int)((((Bot)engine.getBots().get(i)).getY() - 50.0D) * zoomFactor + yModifier));
      af.rotate(((Bot)engine.getBots().get(i)).getHeading(), teamAMainBot.getWidth() / 2, teamAMainBot.getHeight() / 2);
      g2d.drawImage(teamAMainBot, af, this);
      healthBar = new Line(new Point((int)(((Bot)engine.getBots().get(i)).getX() - 50.0D), (int)(((Bot)engine.getBots().get(i)).getY() - 60.0D)), new Point((int)(((Bot)engine.getBots().get(i)).getX() + 50.0D), (int)(((Bot)engine.getBots().get(i)).getY() - 60.0D)), Color.RED);
      

      healthBar.draw(g2d, xModifier, yModifier, zoomFactor, 10);
      if (!((Bot)engine.getBots().get(i)).isDestroyed()) {
        healthBar = new Line(new Point((int)(((Bot)engine.getBots().get(i)).getX() - 50.0D), (int)(((Bot)engine.getBots().get(i)).getY() - 60.0D)), new Point((int)(((Bot)engine.getBots().get(i)).getX() - 50.0D + 100.0D * ((Bot)engine.getBots().get(i)).getHealth() / ((Bot)engine.getBots().get(i)).getMaxHealth()), (int)(((Bot)engine.getBots().get(i)).getY() - 60.0D)), Color.GREEN);
    ...
    for (int i = 3; i < 6; i++) {
      af = new AffineTransform();
      af.translate((int)((((Bot)engine.getBots().get(i)).getX() - 50.0D) * zoomFactor + xModifier), (int)((((Bot)engine.getBots().get(i)).getY() - 50.0D) * zoomFactor + yModifier));
      af.rotate(((Bot)engine.getBots().get(i)).getHeading(), teamBMainBot.getWidth() / 2, teamBMainBot.getHeight() / 2);
    ...
    for (int i = 6; i < 8; i++) {
      af = new AffineTransform();
      af.translate((int)((((Bot)engine.getBots().get(i)).getX() - 50.0D) * zoomFactor + xModifier), (int)((((Bot)engine.getBots().get(i)).getY() - 50.0D) * zoomFactor + yModifier));
      af.rotate(((Bot)engine.getBots().get(i)).getHeading(), teamASecondaryBot.getWidth() / 2, teamASecondaryBot.getHeight() / 2);
    ...
    for (int i = 8; i < 10; i++) {
      af = new AffineTransform();
      af.translate((int)((((Bot)engine.getBots().get(i)).getX() - 50.0D) * zoomFactor + xModifier), (int)((((Bot)engine.getBots().get(i)).getY() - 50.0D) * zoomFactor + yModifier));
      af.rotate(((Bot)engine.getBots().get(i)).getHeading(), teamBSecondaryBot.getWidth() / 2, teamBSecondaryBot.getHeight() / 2);
