...
public class Parameters {
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.HighwayFugitive"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.RussianBrain"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.RussianBrain"; //class given by name; is supposed to extends robotsimulator.Brain
